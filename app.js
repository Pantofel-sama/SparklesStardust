...
// document.addEventListener("click", displayClearAll);
  ...
  div.innerHTML = `<p  id="${id}" class="grocery-item-title">${value}</p>
          ...
          <div class="grocery-item-icons">
            ...
            <a href="#" class="grocery-item-delete">
              <img width="15rem" src="./trash-alt.svg" alt="trash">
            
            </a>
            <a href="#" class="grocery-item-check">
              <img width="15rem" src="./check-square.svg" alt="check">
...
function saveItemInStorage(note) {
  let notes;
  let exists = localStorage.getItem("notes");
